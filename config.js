...
const DiscordStaffChannelId = "1008027638515904572";
...
const DiscordWhitelistRoleIds = "1008029519426375801, 000000000000000000";

// SLASH COMMANDS / DISCORD PERMISSIONS
const EnableDiscordSlashCommands = true;
const DiscordModRoleId = "1008030584506961981";
const DiscordAdminRoleId = "1008030584506961981";
const DiscordGodRoleId = "1008030584506961981";

// DISCORD BOT STATUS
const EnableBotStatusMessages = true;
const BotStatusMessages = [
    "{servername}",
    "{playercount} 💛 Citizens",
];
...
const LoggingWebhookName = "AdminLogs";
